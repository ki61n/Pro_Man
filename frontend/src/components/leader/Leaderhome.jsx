...
function Leaderhome() {
  ...
  useEffect(()=>{
    const  projectdetails=async ()=>{
      try{
       const response=await axios.get(`http://localhost:3000/pname/${id}`)
  ...
  return (
    ...
    <p className='text-5xl text-amber-800 h-[48vh] '>  .</p></header>
    <div className='flex flex-col gap-4 mx-5 sm:mx-14   overflow-hidden'>
   <div className='my-5 bg-blue-100 w-full'> <h1 className='text-3xl sm:text-5xl font-black text-black font-[Poppins,sans-serif] translate-x-5'> Leader projects</h1>
